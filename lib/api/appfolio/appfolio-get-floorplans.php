...
function rentfetch_appfolio_units_small_array() {
	...
	$units_processed = array();

	foreach ( $units as $unit ) {
		$unit_processed = array(
...
function rentfetch_appfolio_add_unit_types_if_missing( $property_units ) {
	...
	$property_units_with_unit_types = array();
...
function rentfetch_appfolio_update_or_create( $floorplans ) {
	...
	foreach ( $floorplans as $floorplan ) {
		...
		if ( ! $matchingposts ) {
			...
			rentfetch_appfolio_update_floorplan( $floorplan, $matchingposts );
...
function rentfetch_appfolio_update_floorplan( $floorplan, $matchingposts ) {
